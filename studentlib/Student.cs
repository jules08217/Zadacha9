...
namespace studentlib
{
    public static class Student
    {
        ...
        public static ArrayList fio = new ArrayList();
        public static ArrayList id = new ArrayList();
        public static ArrayList data = new ArrayList();
        public static ArrayList fii = new ArrayList();

        public static void Dobavit()//Добавить студента
        {
        ...
        public static void Izmenit()//Изменить данные студента
        {
        ...
        public static void Delite()//Удалить студента
        {
            int n = students.Count - 1;
        ...
        public static void InfID()//Информация по ID
        {
        ...
        public static void Vdata()//Кол-во лет студента
        {
            Console.WriteLine("Id студентов:");
            int k = 0;
            int[] cc = new int[4];
        ...
        public static void FII()//Вывод Фамилии и инициалов
        {
            string f1 = "";
            char im = ' ';
            char ot = ' ';
            ...
            for (int i = 0; i < student.Count; i++)
            {
                ...
                string v = f1 + " " + im + '.' + ot + '.';
                fii.Add(v);
                Console.WriteLine(fii[i]);
            } 
        }

        public static void Vvoz()//Вывод студентов младше или старше 18
        {
            int[] cc = new int[4];
            int c1 = 0;
            int voz;
        ...
        public static void PoiskpoF()//Поиск по фамилии
        {
